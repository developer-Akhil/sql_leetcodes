...
cte2 as (select user_id, case when next_date is not null then dateDiff(next_date,visit_date) else
datediff(cast('2021-01-01' as date),visit_date) as window from cte)
